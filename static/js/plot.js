$(document).ready(function() {
  ...
  $("#plot_btn").click(function() {
    ...
    const data_select = $("#data_select").val();
    data = {
      country: country,
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if (Object.keys(data).length == 1) {
          ...
          let predict_array = data[key]["predict_data"];
          let label_array = data[key]["date_array"];
          let data_label = [];
          $("#title_id").text("Covid plot - " + key + " - " + country);
          ...
          keyList.forEach(key => {
            ...
            $("#title_id").text("Covid plot - all data - " + country);
            for (let index = 0; index < data_array.length; index++) {
              data_label.push(label_array[index]);
            }
            let trace1 = {};
